...
train_batch = MyGenerator(train_imgs, generator_config, "training_batch", norm=normalize)
valid_batch = MyGenerator(valid_imgs, generator_config, "validation_batch", norm=normalize)
